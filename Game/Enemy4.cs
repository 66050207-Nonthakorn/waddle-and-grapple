...
public class Enemy4 : GameObject
{
    ...
    private Enemy4BoxCollider _collider;
    ...
    public override void Initialize()
    {
        ...
        _collider = AddComponent<Enemy4BoxCollider>();
    ...
    private void ChangeState(Enemy4State newState)
    {
    ...
    public void Die()
    {
        if (State == Enemy4State.Dead) return;
        VelocityX = 0f;
        VelocityY = 0f;
        ChangeState(Enemy4State.Dead);
    }
}

// ── Concrete BoxCollider สำหรับ Enemy ────────────────────────────────────────
internal sealed class Enemy4BoxCollider : BoxCollider { }
